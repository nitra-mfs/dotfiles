...
BCyan='\e[1;36m'        # Cyan
BWhite='\e[1;37m'       # White# Background
...
NC="\e[m"               # Color Reset# new alert text
ALERT=${BWhite}${On_Red}
...
function maketar() { tar cvzf "${1%%/}.tar.gz"  "${1%%/}/"; }# Create a ZIP archive of a file or folder.
function makezip() { zip -r "${1%%/}.zip" "$1" ; }function extract {
 if [ -z "$1" ]; then
...
[[ -s "/home/raiponce/.gvm/scripts/gvm" ]] && source "/home/raiponce/.gvm/scripts/gvm"
